...
$(function () {
    ...
    $('.main_center .main_center_tabcon01 .arrows .prev').on('click', function () {
        mcs1.slidePrev();
    });
    $('.main_center .main_center_tabcon01 .arrows .next').on('click', function () {
        mcs1.slideNext();
    });
    $('.main_center .main_center_tabcon02 .arrows .prev').on('click', function () {
        mcs2.slidePrev();
    });
    $('.main_center .main_center_tabcon02 .arrows .next').on('click', function () {
        mcs2.slideNext();
    });
